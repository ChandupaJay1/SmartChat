      ...
      <ScrollView>
        <View style={styleSheet.view2}>
            ...
            onEndEditing={async () => {
              if (getMobile.length == 10) {
                let response = await fetch(
                  "https://65a2-2407-c00-4007-5b6e-f152-fb40-8318-e8e0.ngrok-free.app/SmartChat/GetLetters?mobile=" +
                    getMobile
                );
          ...
          <Pressable
            ...
            onPress={async () => {
              let response = await fetch(
                "https://65a2-2407-c00-4007-5b6e-f152-fb40-8318-e8e0.ngrok-free.app/SmartChat/SignIn", // Correct URL
                {
